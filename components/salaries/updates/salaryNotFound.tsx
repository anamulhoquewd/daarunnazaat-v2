...
export function SalaryNotFound({
  error,
  title = "Salary Record Not Found",
  message = "The salary record you're looking for doesn't exist or may have been deleted.",
  showBackButton = true,
}: SalaryNotFoundProps) {
  const router = useRouter();

  const isError = !!error;
  const displayTitle = error ? "Error Loading Salary Record" : title;
